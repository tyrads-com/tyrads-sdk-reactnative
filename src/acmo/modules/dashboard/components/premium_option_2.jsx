...
const PremiumOption2 = ({ data , premiumColor}) => {
  return (
    <AutoScrollPagerWithIndicators
      totalPages={data.length}
      premiumColor={premiumColor}
      content={(page) => (
        <TouchableOpacity key={page} onPress={() => Tyrads.showOffers({
...
const OfferBanner = ({ details, index , premiumColor}) => {
  return (
    <View style={styles.bannerContainer}>
      <Image
        style={styles.bannerImage}
        source={{ uri: details.fileUrl }}
        resizeMode="cover"
      />
