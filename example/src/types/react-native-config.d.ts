declare module 'react-native-config' {
  export interface NativeConfig {
    ...
    IOS_TYRREWARD_SDK_KEY: string;
    IOS_TYRREWARD_SDK_SECRET: string;
    IOS_TYRREWARD_SDK_ENC_KEY: string;
    IOS_BELANDA1_TYRADS_SDK_KEY: string;
    IOS_BELANDA1_TYRADS_SDK_SECRET: string;
    IOS_BELANDA1_TYRADS_SDK_ENC_KEY: string;
    IOS_BELANDA2_TYRADS_SDK_KEY: string;
    IOS_BELANDA2_TYRADS_SDK_SECRET: string;
    IOS_BELANDA2_TYRADS_SDK_ENC_KEY: string;
    IOS_BELANDA3_TYRADS_SDK_KEY: string;
    IOS_BELANDA3_TYRADS_SDK_SECRET: string;
    IOS_BELANDA3_TYRADS_SDK_ENC_KEY: string;
  }
